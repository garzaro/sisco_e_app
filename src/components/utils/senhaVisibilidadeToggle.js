...
const SenhaVisibilidadeToggle = ({ mostrarSenha, onClick }) => {
    return (
        ...
        >
            ...
            {mostrarSenha ? (
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="blue" className="bi bi-eye-slash-fill" viewBox="0 0 16 16">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="blue" className="bi bi-eye-fill" viewBox="0 0 16 16">
